...
Create a Rust binary package named `tissue` with dependencies for async GitHub access, TUI rendering, terminal input, command-line parsing, and tests.
